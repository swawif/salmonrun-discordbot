...
exports.nextSchedules = function nextSalmon(num){
...
exports.mapName = function mapNames(a) {
    ...
    currentMap = coopSchedule.details[0].stage.name;
...
exports.weaponName = function weapons(a){
    var currentWeapon1 = coopSchedule.details[0].weapons[0].weapon.name;                //get current weapon names
    var currentWeapon2 = coopSchedule.details[0].weapons[1].weapon.name;
    var currentWeapon3 = coopSchedule.details[0].weapons[2].weapon.name;
    var currentWeapon4 = coopSchedule.details[0].weapons[3].weapon.name;

    var weaponString = currentWeapon1 + ", " + currentWeapon2 + ", " + currentWeapon3 + ", " + currentWeapon4;
    console.log(weaponString);
    return weaponString;
};

exports.imageLink = function image(a){
    var currentMap = coopSchedule.details[0].stage.name;
    var mapImage = "";
    switch(currentMap){
        default:
